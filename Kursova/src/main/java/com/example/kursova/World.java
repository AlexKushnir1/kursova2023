...
public class World extends Pane {
    ...
    public World(int contentWidth, int contentHeight) {
        ...
        BackgroundImage backgroundTexture = new BackgroundImage(image, BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, new BackgroundSize(5500,5000, true,true,true,true));
    ...
    public void addSystem(Bases system) {
    ...
    public void addFlag(Flag flag) {
        // Додавання макрооб'єкту
        content.getChildren().add(flag);
        flag.setLayoutX(flag.getX());
        flag.setLayoutY(flag.getY());
    }
    ...
    public void removeObj(smok obj) {
        if (content.getChildren().contains(obj)) {
    ...
    public void removeList(List<smok> objects) {
